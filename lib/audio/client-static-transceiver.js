...
module.exports = class ClientAudioStTransceiver extends BaseProvider {
  ...
  toggleListenOnlyMode (enabled) {
    if (enabled && this._mode !== C.RECV_ROLE) {
      ...
      return this.mcs.connect(
        ...
        this._mode = C.RECV_ROLE;
        return true;
      });
    } else if (!enabled && this._mode !== C.SENDRECV_ROLE) {
