...
const SFUA_NAMES = {
  ...
  TRANSCEIVER_CONSUMER_RESTARTS: 'sfu_audio_transceiver_consumer_restarts_total',
...
const buildDefaultMetrics = () => {
  if (AUDIO_METRICS == null) {
    AUDIO_METRICS = {
      ...
      [SFUA_NAMES.TRANSCEIVER_CONSUMER_RESTARTS]: new Counter({
        name: SFUA_NAMES.TRANSCEIVER_CONSUMER_RESTARTS,
        help: 'Total number of transceiver consumer restarts in the audio module',
      }),
