...
const MediaController = new (require('../media/media-controller.js'));
const {
  Gauge,
  Counter,
} = require('prom-client');
  ...
  if (METRICS == null) {
    METRICS = {
      [METRIC_NAMES.ROOMS]: new Gauge({
        ...
        collect() {
          this.set(MediaController.getNumberOfRooms());
        },
      }),
      ...
      [METRIC_NAMES.USERS]: new Gauge({
        ...
        collect() {
          this.set(MediaController.getNumberOfUsers());
        },
      }),
      ...
      [METRIC_NAMES.MEDIA_SESSIONS]: new Gauge({
        ...
        collect() {
          this.set(MediaController.getNumberOfMediaSessions());
        },
      }),
      ...
      [METRIC_NAMES.MEDIA_UNITS]: new Gauge({
        ...
        labelNames: ['media_type', 'unit_type'],
      }),
