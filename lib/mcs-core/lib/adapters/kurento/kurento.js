      ...
      try {
        ...
        if (mediaElement) {
          mediaElement.generateOffer((error, offer) => {
            ...
            offer = offer.replace(/a=rtcp-fb:101 nack/ig, '');
            offer = offer.replace(/a=rtcp-fb:101 nack pli/ig, '');
            offer = offer.replace(/a=rtcp-fb:101 ccm fir/ig, 'a=fmtp:101 profile-level-id=42E01f;packetization-mode=1');
