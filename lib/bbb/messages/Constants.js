 ...
 */
  function Constants () {
    return {
        ...
        FROM_VOICE_CONF: 'from-voice-conf-redis-channel',
        ...
        RECORDING_STATUS_CHANGED_EVT_MSG: "RecordingStatusChangedEvtMsg",
        PLUGIN_PERSIST_EVENT_EVT_MSG: "PluginPersistEventEvtMsg",
        ...
        GET_MIC_PERM_REQ_MSG: "GetMicrophonePermissionReqMsg",
        GET_MIC_PERM_RESP_MSG: "GetMicrophonePermissionRespMsg",
        ...
        HOLD_CHANNEL_IN_VOICE_CONF_SYS_MSG: "HoldChannelInVoiceConfSysMsg",
        CHANNEL_HOLD_CHANGED_VOICE_CONF_EVT_MSG: "ChannelHoldChangedVoiceConfEvtMsg",
        USER_LEFT_VOICE_CONF_TO_CLIENT_EVT_MSG: "UserLeftVoiceConfToClientEvtMsg",
        MUTE_USER_CMD_MSG: "MuteUserCmdMsg",
        USER_MUTED_VOICE_EVT_MSG: "UserMutedVoiceEvtMsg",
        USER_MUTED_IN_VOICE_CONF_EVT_MSG: "UserMutedInVoiceConfEvtMsg",
        VOICE_CONF_CALLSTATE_EVT_MSG: "VoiceConfCallStateEvtMsg",
        GENERATE_LIVEKIT_TOKEN_REQ_MSG: "GenerateLiveKitTokenReqMsg",
        GENERATE_LIVEKIT_TOKEN_RESP_MSG: "GenerateLiveKitTokenRespMsg",
        GENERATE_BREAKOUT_ROOM_LIVEKIT_TOKEN_REQ_MSG: "GenerateBreakoutRoomLiveKitTokenReqMsg",
        GENERATE_BREAKOUT_ROOM_LIVEKIT_TOKEN_RESP_MSG: "GenerateBreakoutRoomLiveKitTokenRespMsg",
        MUTE_USER_IN_VOICE_CONF_SYS_MSG: "MuteUserInVoiceConfSysMsg",
        USER_JOINED_VOICE_CONF_EVT_MSG: "UserJoinedVoiceConfEvtMsg",
        USER_LEFT_VOICE_CONF_EVT_MSG: "UserLeftVoiceConfEvtMsg",
        USER_BROADCAST_CAM_START_MSG: "UserBroadcastCamStartMsg",
        USER_BROADCAST_CAM_STOP_MSG: "UserBroadcastCamStopMsg",
        MEETING_CREATED_EVT_MSG: "MeetingCreatedEvtMsg",
        MEETING_ENDED_EVT_MSG: "MeetingEndedEvtMsg",
        EJECT_ALL_FROM_VOICE_CONF: 'EjectAllFromVoiceConfMsg',
        EJECT_USER_FROM_VOICE_CONF_SYS_MSG: "EjectUserFromVoiceConfSysMsg",
        UPDATE_LIVEKIT_PARTICIPANT_PERMISSIONS_SYS_MSG: "UpdateLiveKitParticipantPermissionsSysMsg",
        UPDATE_LIVEKIT_PARTICIPANT_PERMISSIONS_RESP_MSG: "UpdateLiveKitParticipantPermissionsRespMsg",
        EJECT_USER_FROM_VOICE_CONF_RESP_MSG: "EjectUserFromVoiceConfRespMsg",
        SET_USER_TALKING_REQ_MSG: "SetUserTalkingReqMsg",

        // Outcome of a media-stack action akka-apps requested
        MEDIA_ACTION_OUTCOME: {
          APPLIED: "applied",
          ROOM_ABSENT: "roomAbsent",
          PARTICIPANT_ABSENT: "participantAbsent",
          FAILED: "failed",
        },

        //UserLeftVoiceConfEvtMsg
        VOICE_USER_ID: "voiceUserId",
        INT_ID: "intId",
        MUTED: "muted",
        TALKING: "talking",
        CALLING_WITH: "callingWith",
        HOLD: "hold",
        UUID: "uuid",
        ...
        AUDIO_TRACK_PUBLISHED_EVT: "AudioTrackPublishedEvent",
        AUDIO_TRACK_UNPUBLISHED_EVT: "AudioTrackUnpublishedEvent",
        SHARE_EVT_USER_ID_KEY: "userId",
        RECORDING: "recording",
        ...
        RECORDING_MODULE_SFU: 'bbb-webrtc-sfu',
        ...
        MEDIA_RESTARTING: 'MEDIA_RESTARTING',
        MEDIA_RESTARTED: 'MEDIA_RESTARTED',
        MEDIA_PAUSED: 'MEDIA_PAUSE',
        MEDIA_USER_JOINED: 'MEDIA_USER_JOINED',
        MEDIA_CONSUMER_BRIDGE_STARTED: 'MEDIA_CONSUMER_BRIDGE_STARTED',
        MEDIA_CONSUMER_BRIDGE_RESTARTING: 'MEDIA_CONSUMER_BRIDGE_RESTARTING',
        MEDIA_CONSUMER_BRIDGE_RESTARTED: 'MEDIA_CONSUMER_BRIDGE_RESTARTED',
    }
}
