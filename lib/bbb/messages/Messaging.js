...
const SFUMuteStateChangedReqMsg =
  require('./audio/SFUMuteStateChangedReqMsg.js');
const Hold =
  require('./audio/Hold.js');
...
module.exports = {
  ...
  generateSFUMuteStateChangedReqMsg: (
    meetingId, userId, muted, mutedBy, sfuSessionId,
  ) => {
    return (new SFUMuteStateChangedReqMsg(
      meetingId, userId, muted, mutedBy, sfuSessionId,
    )).toJson();
  },

  generateHold: (
    meetingId, voiceConf, voiceUserId, hold
  ) => {
    return (new Hold(
      meetingId, voiceConf, voiceUserId, hold,
    )).toJson();
