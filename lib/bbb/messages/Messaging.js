...
Messaging.prototype.generateStreamEventMessage =
  function(meetingId, userId, state, streamUrl, streamType, streamId) {
    let msg = new StreamEventMessage2x(meetingId, userId, state, streamUrl, streamType, streamId);
    return msg.toJson();
}
...
Messaging.prototype.generateStreamOAuth2DataMessage =
  function(meetingId, userId, key, id, err) {
    let msg = new StreamOAuth2DataMessage2x(meetingId, userId, key, id, err);
    return msg.toJson();
}
