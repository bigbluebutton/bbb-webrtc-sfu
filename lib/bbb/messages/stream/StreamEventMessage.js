...
module.exports = function (C) {
  function MeetingStreamMessage2x (meetingId, userId, state, streamUrl, streamType, streamId) {
    const name = (state === C.STREAM_STARTED) ? C.MEETING_STREAM_STARTED_MESSAGE_2x : C.MEETING_STREAM_STOPPED_MESSAGE_2x;
    MeetingStreamMessage2x.super_.call(this, name, {sender: 'bbb-webrtc-sfu'}, {meetingId, userId});
