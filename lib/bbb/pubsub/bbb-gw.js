  ...
  incomingMessage (message) {
    ...
    if (header) {
      switch (header.name) {
        // FIXME tainted
        case C.USER_MUTED:
          this.emit(C.USER_MUTED+header.userId, payload);
          this.emit(C.USER_MUTED, payload);
          break;
        case C.USER_JOINED_VOICE_CONF_EVT_MSG:
          this.emit(C.USER_JOINED_VOICE_CONF_EVT_MSG+payload.intId, payload);
          this.emit(C.USER_JOINED_VOICE_CONF_EVT_MSG, payload);
          break;
