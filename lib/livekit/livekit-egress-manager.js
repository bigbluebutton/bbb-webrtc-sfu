      ...
      switch (source) {
        case 'microphone':
          output = new this._liveKitSDK.DirectFileOutput({
            filepath: `/var/lib/bbb-webrtc-recorder/audio/${roomName}/${source}-${participantId}-${trackId}.ogg`,
          });
          break;

        case 'camera': {
          output = new this._liveKitSDK.DirectFileOutput({
            filepath: `/var/lib/bbb-webrtc-recorder/recordings/${roomName}/${source}-${participantId}-${trackId}.webm`,
          });
          break;
        }
        ...
        case 'screen_share': {
          output = new this._liveKitSDK.DirectFileOutput({
            filepath: `/var/lib/bbb-webrtc-recorder/screenshare/${roomName}/${source}-${participantId}-${trackId}.webm`,
          });
          break;
        }
