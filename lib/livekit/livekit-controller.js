...
const {
  ...
  camStopGraceMs: CAM_STOP_GRACE_MS = 15000,
...
class LiveKitController extends BaseManager {
  ...
  _deleteRoom (meetingId) {
    ...
    this.bbbManager?.clearPendingCamStops(meetingId);
  }
  ...
  async start () {
    ...
    this.bbbManager = new LiveKitBbbManager(
      ...
      this._roomMap, {
        ...
        camStopGraceMs: CAM_STOP_GRACE_MS,
      },
    );
  ...
  async stop () {
    ...
    this.bbbManager?.clearAllPendingCamStops();
