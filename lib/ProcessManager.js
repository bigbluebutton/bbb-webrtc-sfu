...
const STREAM_PATH = './lib/stream/StreamProcess.js';
...
module.exports = class ProcessManager {
  ...
  async start () {
    ...
    let screenshareProcess, videoProcess, audioProcess, streamProcess;

    setTimeout(() => {
      screenshareProcess = this.startProcess(SCREENSHARE_PATH);
      videoProcess = this.startProcess(VIDEO_PATH);
      audioProcess = this.startProcess(AUDIO_PATH);
      streamProcess = this.startProcess(STREAM_PATH);
      ...
      this.processes[streamProcess.pid] = streamProcess;
    }, 500);
