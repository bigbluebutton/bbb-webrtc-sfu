...
module.exports = class BaseProvider extends EventEmitter {
    ...
    _validateErrorMessage(error) {
        const { type = null, id = null, role = null, streamId = null, code = null, reason = null, } = error;
    ...
    flushCandidatesQueue(broker, queue, mediaId = null) {
        if (mediaId) {
            ...
            queue.forEach((candidate) => __awaiter(this, void 0, void 0, function* () {
                try {
                    yield broker.addIceCandidate(mediaId, candidate);
                }
                catch (e) {
