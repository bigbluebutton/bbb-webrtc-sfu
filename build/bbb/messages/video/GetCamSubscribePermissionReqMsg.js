...
module.exports = class GetCamSubscribePermissionReqMsg extends OutMessage2x {
    constructor(meetingId, userId, streamId, sfuSessionId) {
        super(C.GET_CAM_SUBSCRIBE_PERM_REQ_MSG, { sender: 'bbb-webrtc-sfu' }, { meetingId, userId });
        this.core.body = {};
