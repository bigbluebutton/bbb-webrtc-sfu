...
module.exports = class ScreenshareRTMPBroadcastStoppedEventMessage2x extends OutMessage2x {
    constructor(conferenceName, screenshareConf, streamUrl, vw, vh, timestamp) {
        super(C.SCREENSHARE_RTMP_BROADCAST_STOPPED_2x, { voiceConf: conferenceName }, { voiceConf: conferenceName });
        this.core.body = {};
