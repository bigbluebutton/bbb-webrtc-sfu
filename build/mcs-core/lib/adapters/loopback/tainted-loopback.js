...
module.exports = class TaintedLoopbackAdapter extends EventEmitter {
    ...
    setMediaElement(mediaElement) {
        ...
        if (typeof this._mediaElements[enrichedId] === 'object') {
            return this._handleError(Object.assign(Object.assign({}, C.ERROR.MEDIA_ID_COLLISION), { details: "TLA_ID_COLLISION" }));
        }
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        if (d) {
                            ...
                            answer = yield this.generateOffer(mediaElement, filterOptions);
                        }
