...
const { MCSPrometheusAgent, METRIC_NAMES, registerMediaSessionTypeMetrics, } = require('../metrics/index.js');
let instance = null;
let clientId = 0;
const MR = class MCSRouter {
    ...
    connect(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(cPromises).then(() => {
                    return;
                }).catch((err) => {
    ...
    disconnect(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(dcPromises).then(() => {
                    return;
                }).catch((err) => {
    ...
    addIceCandidate(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this._mediaController.addIceCandidate(mediaId, candidate);
                return;
            }
            catch (error) {
    ...
    _notifyMethodError(client, error, method, transactionId = null) {
        ...
        if (method)
            MCSPrometheusAgent.increment(METRIC_NAMES.REQUEST_ERRORS_TOTAL, { method, errorCode: error.code });
    }
    ...
    setupClient(client) {
        ...
        client.on('publishAndSubscribe', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId;
            try {
                ({ transactionId } = args);
                const { descriptor, mediaId } = yield this.publishnsubscribe(args);
        ...
        client.on('unpublishAndUnsubscribe', (args) => __awaiter(this, void 0, void 0, function* () {
            let userId, mediaId, transactionId;
            try {
                ({ userId, mediaId, transactionId } = args);
                yield this.unpublishAndUnsubscribe(args);
        ...
        client.on('publish', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId;
            try {
                ({ transactionId } = args);
                const { descriptor, mediaId } = yield this.publish(args);
        ...
        client.on('unpublish', (args) => __awaiter(this, void 0, void 0, function* () {
            let userId, mediaId, transactionId;
            try {
                ({ userId, mediaId, transactionId } = args);
                yield this.unpublish(args);
        ...
        client.on('subscribe', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId;
            try {
                ({ transactionId } = args);
                const { descriptor, mediaId } = yield this.subscribe(args);
        ...
        client.on('unsubscribe', (args) => __awaiter(this, void 0, void 0, function* () {
            let userId, mediaId, transactionId;
            try {
                ({ userId, mediaId, transactionId } = args);
                yield this.unsubscribe(args);
        ...
        client.on('addIceCandidate', (args) => __awaiter(this, void 0, void 0, function* () {
            let mediaId, transactionId;
            try {
                ({ mediaId, transactionId } = args);
                yield this.addIceCandidate(args);
        ...
        client.on('connect', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId, source_id, sink_ids;
            try {
                ({ transactionId, source_id, sink_ids } = args);
                yield this.connect(args);
        ...
        client.on('disconnect', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId, source_id, sink_ids;
            try {
                ({ transactionId, source_id, sink_ids } = args);
                yield this.disconnect(args);
        ...
        client.on('onEvent', (args) => __awaiter(this, void 0, void 0, function* () {
            try {
                Logger.trace("[mcs-router] Client", client.trackingId, "subscribing to event", args);
                this._addToClientEventMap(args, client);
                yield this.onEvent(args);
            }
            catch (error) {
                Logger.error('[mcs-router] OnEvent error', error);
            }
        }));
        client.on('startRecording', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId;
            try {
                ({ transactionId } = args);
                const recordingId = yield this.startRecording(args);
        ...
        client.on('stopRecording', (args) => __awaiter(this, void 0, void 0, function* () {
            let recordingId, transactionId;
            try {
                ({ recordingId, transactionId } = args);
                yield this.stopRecording(args);
        ...
        client.on('setVolume', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId, mediaId, volume;
            try {
                ({ transactionId, mediaId, volume } = args);
                yield this.setVolume(args);
        ...
        client.on('mute', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId, mediaId;
            try {
                ({ transactionId, mediaId } = args);
                yield this.mute(args);
        ...
        client.on('unmute', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId, mediaId;
            try {
                ({ transactionId, mediaId } = args);
                yield this.unmute(args);
        ...
        client.on('dtmf', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId, mediaId, tone;
            try {
                ({ transactionId, mediaId, tone } = args);
                yield this.dtmf(args);
        ...
        client.on('requestKeyframe', (args) => __awaiter(this, void 0, void 0, function* () {
            let transactionId, mediaId;
            try {
                ({ transactionId, mediaId } = args);
                yield this.requestKeyframe(args);
    ...
    _dispatchEvents() {
        ...
        this.emitter.on(C.EVENT.MEDIA_STATE.MEDIA_EVENT, event => {
            ...
            state = Object.assign(Object.assign({}, state), { timestampHR, timestampUTC, rawEvent });
