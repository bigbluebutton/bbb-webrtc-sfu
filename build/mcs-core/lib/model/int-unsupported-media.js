...
module.exports = class InternalUnsupportedMedia extends Media {
    constructor(room, user, mediaSessionId, remoteDescriptor, type) {
    ...
    set remoteDescriptor(remoteDescriptor) {
        if (remoteDescriptor) {
            this._remoteDescriptor = new SdpWrapper(remoteDescriptor, C.DEFAULT_MEDIA_SPECS, C.MEDIA_PROFILE.INTERNAL_UNSUPPORTED, { preProcess: false });
    ...
    set localDescriptor(localDescriptor) {
        if (localDescriptor) {
            this._localDescriptor = new SdpWrapper(localDescriptor, C.DEFAULT_MEDIA_SPECS, C.MEDIA_PROFILE.INTERNAL_UNSUPPORTED, { preProcess: false });
        }
    }
    get localDescriptor() {
