...
module.exports = class SDPMedia extends Media {
    constructor(room, user, mediaSessionId, remoteDescriptor, localDescriptor, type, adapter, adapterElementId, host, options) {
        ...
        if (localDescriptor) {
            ...
            if (this.type !== C.MEDIA_TYPE.WEBRTC) {
                ...
                if (this.remoteDescriptor == null || this.remoteDescriptor.remoteConnectionData == null) {
                    ...
                    ip = getMappedIP(remoteIP, this.host.ipClassMappings);
    ...
    addIceCandidate(candidate) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.adapter.addIceCandidate(this.adapterElementId, candidate);
                resolve();
            }
            catch (err) {
