...
module.exports = class MediaSession {
    constructor(room, user, type = 'WebRtcEndpoint', options = {}) {
        this.id = rid();
        this.roomId = room;
        this.userId = user;
    ...
    stop() {
        if (this._status === C.STATUS.STARTED || this._status === C.STATUS.STARTING) {
            ...
            try {
                this.medias.forEach((m) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        yield m.stop();
                    }
                    catch (error) {
                        Logger.error(LOG_PREFIX, `Error when stopping media ${m.id}`, Object.assign({ error }, m.getMediaInfo()));
                    }
                }));
                this._status = C.STATUS.STOPPED;
    ...
    _connect(sink, connectionType) {
        ...
        const meshConnect = (sources, sinks, type) => {
            sinks.forEach((sim, i) => __awaiter(this, void 0, void 0, function* () {
        ...
        switch (connectionType) {
            ...
            case C.CONNECTION_TYPE.ALL:
                ...
                break;
            default:
                throw Object.assign(Object.assign({}, C.ERROR.MEDIA_INVALID_TYPE), { details: `Invalid connection type ${connectionType}` });
        }
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.medias.forEach(som => {
                ...
                sinkMediasToDisconnect.forEach(sim => {
                    ...
                    try {
                        return som.disconnect(sim, connectionType);
                    }
                    catch (err) {
                        throw (this._handleError(err));
                    }
    ...
    dtmf(tone) {
        try {
            ...
            if (media == null) {
                throw (this._handleError(Object.assign(Object.assign({}, C.ERROR.MEDIA_NOT_FOUND), { details: "MEDIA_SESSION_DTMF_NO_AVAILABLE_MEDIA_UNIT" })));
            }
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                if (mediasToRequest.length <= 0) {
                    throw (this._handleError(Object.assign(Object.assign({}, C.ERROR.MEDIA_NOT_FOUND), { details: "MEDIA_SESSION_REQUEST_KEYFRAME_NO_AVAILABLE_MEDIA_UNIT" })));
                }
                mediasToRequest.forEach((m) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        yield m.requestKeyframe();
                    }
                    catch (err) {
